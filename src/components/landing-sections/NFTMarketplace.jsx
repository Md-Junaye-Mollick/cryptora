        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative lg:pr-12 order-2 lg:order-1">
            <div className="relative rounded-lg overflow-hidden shadow-2xl">
              ...
              >
                <source src="/images/videos/NFTVideo.mp4" type="video/mp4" />
              </video>
          ...
          <div className="space-y-5 order-1 lg:order-2">
            <h2 className="text-4xl lg:text-5xl font-bold">
              <span className="text-orange-500">NFT</span>{' '}
              <span className="text-white">MARKETPLACE</span>
            </h2>

            <p className="text-gray-300 text-lg md:text-xl leading-relaxed max-w-2xl">
              Cryptora's real-world expertise allows us to provide our clients with
              comprehensive token production tools across industry hosts. Here are the
