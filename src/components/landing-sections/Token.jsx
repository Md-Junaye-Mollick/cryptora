        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-5">
            ...
            <p className="text-gray-300 text-lg md:text-xl leading-relaxed max-w-2xl">
              Cryptora's real-world expertise allows us to provide our clients with
              comprehensive token production tools across industry hosts. Here are
              the features of Token Development Services.
            </p>
          ...
          <div className="relative lg:pl-12">
            <div className="relative rounded-lg overflow-hidden shadow-2xl">
              ...
              >
                <source src="/images/videos/tokenVideo.mp4" type="video/mp4" />
              </video>
